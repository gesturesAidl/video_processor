...
=================
  ...
  * [ABLATION STUDIES](#ablation-studies)
	 * [OPTICAL FLOW IMPROVEMENTS](#optical-flow-improvements)
	 	* [Image Quantization + noise reduction](#image-quantization--noise-reduction)
	 	* [Reduce luminosity component](#reduce-luminosity-component)
	 	* [Sparse optical flow](#sparse-optical-flow)
	 	* [Paper: Apply a mask](#paper-apply-a-mask)
